...
const RiskManagement = () => {
    ...
    return (
        <Container maxWidth="lg">
                ...
                <Grid item xs={12} md={6}>
                    <Paper elevation={3} sx={{ p: 2 }}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <Button variant="contained" color="primary" onClick={handleUpdateLimits} fullWidth>
                                    Update Limits
                                </Button>
                            </Grid>
                        </Grid>
            ...
            <Box mt={4}>
                <Paper elevation={3} sx={{ p: 2, backgroundColor: theme.palette.background.default }}>
                    <Typography variant="h6" gutterBottom>
                    ...
                    <Typography variant="body1">
                        2. Diversify your portfolio to spread risk across different currency pairs.
                    </Typography>
                    <Typography variant="body1">
                        3. Regularly review and adjust your risk limits based on market conditions.
                    </Typography>
                    <Typography variant="body1">
                        4. Monitor your total exposure and avoid overexposure to a single currency.
                    </Typography>
                </Paper>
            </Box>
        </Container>
